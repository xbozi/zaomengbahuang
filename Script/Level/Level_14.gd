...
var _2 = preload("res://Scene/Monster/Monster_37.tscn")
...
func _ready() -> void:
	Global.CurrentLevel = "接引院"
	Global.addBGM_(self,"res://Music/level/4_bg2.mp3")
	self.level_stage = 14
	super._ready()
	Monster_group = {
		"stage_1": [40,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40],
		"stage_2": [39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40],
		"stage_3": [39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40,39,40],
		"stage_4": [37],
	}
	Monster_position_x = {
