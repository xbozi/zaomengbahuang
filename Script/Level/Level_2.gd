...
var _4 = preload("res://Scene/Monster/Monster_4.tscn")
#var _5 = preload("res://Scene/Level/Level_sjg.tscn")
func _ready() -> void:
	Global.CurrentLevel = "水帘洞"
	Global.addBGM_(self,"res://Music/level/1_music.mp3")
	self.level_stage = 2#处于哪个等级
	super._ready()
	Monster_group = {
		"stage_1": [1,1,1,1,1,1,1,1],
...
func _on_area_2d_body_entered(body: Node2D) -> void:
	Global.change_secen("res://Scene/Level/Level_sjg.tscn")
