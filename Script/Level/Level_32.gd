...
func _ready() -> void:
	preload("res://Scene/Monster/Monster_120.tscn")
	preload("res://Scene/Monster/Monster_119.tscn")
#	preload("res://Scene/Monster/Monster_116.tscn")
#	preload("res://Scene/Monster/Monster_117.tscn")
	Global.CurrentLevel = "九龙岛"
	Global.addBGM_(self,"res://Music/level/34_bg5.mp3")
	self.level_stage = 37
	super._ready()
	Monster_group = {
		"stage_1": [119,119,119,119,119,119,119,119,119,119,119,119,119,119,119,119,119,119],
		"stage_2": [119,119,119,119,119,119,119,119,119,119,119,119,119,119,119,120,120,120,120,120,120,120,120,119,120,119,120,119,120,119,120,119,120],
		"stage_3": [119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120,119,120],
		"stage_4": [140],
	}
	Monster_position_x = {
