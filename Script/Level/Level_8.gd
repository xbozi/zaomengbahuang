...
var _6 = preload("res://Scene/Monster/Monster_18.tscn")

func _ready() -> void:
	Global.CurrentLevel = "东海"
	Global.addBGM_(self,"res://Music/level/21_bg3.mp3")
	self.level_stage = 8#处于哪个等级
	super._ready()
	Monster_group = {
		"stage_1": [16,16,14,14,15,15,15,15],
		"stage_2": [14,14,16,15,15,16,15,14,16,14,16,15,15,14,16,14,16,14,16,15,15,14,16,14],
		"stage_3": [14,14,16,16,16,15,16,14,16,15,16,14,16,17,16,14,16,15,15,14,16,14],
		"stage_4": [18],
	}
	Monster_position_x = {
		"stage_1": [900,900,900,900,700,700,700,700],
		"stage_2": [1100,1100,1100,2000,2000,2000,2000,1400,1400,1600,1600,1600,1400,1800,1800,1800,1400,1600,1600,1600,1400,1800,1800,1800],
		"stage_3": [2700,2705,2700,2700,2700,3000,3000,3000,3000,3200,3200,3200,3300,3300,3000,3000,3000,3200,3200,3200,3300,3300],
		"stage_4": [4550],
	}
	Monster_position_y = {
		"stage_1": [300,300,300,300,300,300,300,300,300],
		"stage_2": [250,250,250,250,250,250,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300],
		"stage_3": [200,200,200,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300,300],
		"stage_4": [300],
	}
