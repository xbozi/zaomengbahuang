...
func _ready() -> void:
	Global.CurrentLevel = "朝会殿"
	Global.addBGM_(self,"res://Music/level/Floor_7-10.mp3")
	self.level_stage = 28
	super._ready()
	Monster_group = {
		"stage_1": [86,86,86,86,87,87,87,87,87,87,87,87,87,87,87,87,87,87],
		"stage_2": [86,86,86,86,86,86,86,86,86,87,90,87,90,87,90,87,90,87,90,87,90,87,90,87,90,88,88,88,88,88,88,88,88],
		"stage_3": [86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88,86,87,90,88],
		"stage_4": [91],
	}
	Monster_position_x = {
